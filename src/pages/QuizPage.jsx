...
const QuizPage = () => {
    ...
    }, [currentQuestionIndex, quizFinished, isAnswered]);
    ...
    }, [currentQuestionIndex, questions.length, sounds.excitement]);
    ...
    const handleAnswer = useCallback((answer) => {
        ...
        nextQuestionTimerRef.current = setTimeout(handleNextQuestion, 2000);
    }, [isAnswered, questions, currentQuestionIndex, sounds, handleNextQuestion]);
