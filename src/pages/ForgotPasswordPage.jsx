          ...
          <Card className='backdrop-blur-xl bg-white/80 dark:bg-gray-900/80 border border-white/20 dark:border-gray-700/20 shadow-2xl'>
            <CardHeader className='text-center'>
              ...
              <CardDescription className='text-base'>
                Endişelenmeyin! Şifrenizi sıfırlamak için e-posta adresinizi
                girin.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {messageSent ? (
                <div className='text-center p-4 rounded-lg bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700'>
                  ...
                  <p className='text-muted-foreground mt-2'>
                    Eğer e-posta adresiniz sistemimizde kayıtlıysa, şifre
                    sıfırlama bağlantısı gönderilecektir. Gelen kutunuzu ve spam
                    klasörünü kontrol etmeyi unutmayın.
                  </p>
                  <Button
