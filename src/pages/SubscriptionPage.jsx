...
import { Shield, Star, Languages, Volume2, Bookmark, Bot, Sparkles, BarChart, FileText, DownloadCloud, LifeBuoy, Info, Loader2 } from 'lucide-react';
...
const SubscriptionPage = () => {
  ...
  const features = [
    ...
    { icon: Bookmark, text: "Kaldığın yeri işaretle, öğrenmeye ara verme" },
    { icon: Bot, text: "Yapay zeka destekli kişisel öğrenme asistanı" },
    { icon: Shield, text: "Reklamsız ve kesintisiz bir öğrenme deneyimi" },
    { icon: Sparkles, text: "Yeni hikayelere ve özelliklere herkesten önce eriş" },
    { icon: BarChart, text: "Detaylı ilerleme takibi ve haftalık raporlar" },
    { icon: FileText, text: "Tüm hikayeleri PDF olarak indirme ve yazdırma" },
    { icon: DownloadCloud, text: "Çevrimdışı erişim için hikayeleri kaydetme" },
    ...
    <>
      ...
      <div className="relative min-h-screen bg-gray-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 overflow-hidden">
        ...
        <motion.main
          ...
          className="relative container mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8"
        >
          <motion.div 
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.6, delay: 0.1 }}
            className="text-center mb-12 p-6 md:p-8 glass-box"
          >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            >
              <Card className="bg-white/80 dark:bg-slate-800/50 shadow-lg border border-slate-200 dark:border-slate-700/50 h-full backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="text-2xl font-bold text-slate-900 dark:text-white">Premium İle Gelenler</CardTitle>
            ...
            >
              <Card className="relative bg-white dark:bg-slate-800/80 shadow-2xl border-2 border-primary/50 backdrop-blur-sm">
                ...
                <CardHeader className="text-center pt-8">
                  <CardTitle className="text-3xl font-bold text-slate-900 dark:text-white">Premium Plan</CardTitle>
                ...
                <CardContent className="p-6">
                  ...
                  <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    <DialogTrigger asChild>
                      <Button className="w-full text-lg cta-glow-button py-6" size="lg">
                        Güvenli Ödeme Yap
                      </Button>
                    </DialogTrigger>
