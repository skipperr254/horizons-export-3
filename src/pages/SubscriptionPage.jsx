...
const SubscriptionPage = () => {
  ...
  const features = [
    ...
    {
      icon: Sparkles,
      text: "Yeni hikayelere ve özelliklere herkesten önce eriş",
    },
        ...
        >
          ...
          >
            ...
            <p className='mt-4 text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto'>
              Premium'a geçerek tüm özelliklerin kilidini açın. Güvenli ödeme
              altyapısıyla hemen başlayın.
            </p>
          </motion.div>
              ...
              <Card className='bg-white/80 dark:bg-slate-800/50 shadow-lg border border-slate-200 dark:border-slate-700/50 h-full backdrop-blur-sm'>
                <CardHeader>
                  <CardTitle className='text-2xl font-bold text-slate-900 dark:text-white'>
                    Premium İle Gelenler
                  </CardTitle>
                  <CardDescription>
                    Tüm bu özellikler ve daha fazlası sizi bekliyor.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className='relative bg-white dark:bg-slate-800/80 shadow-2xl border-2 border-primary/50 backdrop-blur-sm'>
                ...
                <CardContent className='p-6'>
                  ...
                  <div className='mt-6 text-center text-xs text-muted-foreground p-3 bg-secondary/50 rounded-lg flex items-start space-x-2'>
                    ...
                    <span>
                      İstediğin zaman iptal edebilirsin. İptal ettiğinde, mevcut
                      fatura döneminin sonuna kadar tüm premium özelliklerden
                      yararlanmaya devam edersin.
                    </span>
                  </div>
                </CardContent>
              </Card>
