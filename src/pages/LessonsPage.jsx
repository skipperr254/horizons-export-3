...
const Playlist = ({
  ...
  return (
    <Card className="lg:h-full lg:flex lg:flex-col bg-card/80 backdrop-blur-sm shadow-xl mt-8 lg:mt-0">
      <CardHeader>
      ...
      <CardContent className="flex flex-col gap-4 lg:flex-grow lg:overflow-y-auto p-3">
  ...
  const fetchInitialData = useCallback(async () => {
    ...
    try {
      const [lessonsRes, categoriesRes, progressRes] = await Promise.all([
        ...
        supabase.from('lesson_categories').select('*').order('name'),
