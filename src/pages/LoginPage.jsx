  ...
  useEffect(() => {
    const fetchSlides = async () => {
      ...
      const { data, error } = await supabase
        ...
        .select('title, subtitle, image_url, gradient_colors, avatar_url, user_title')
      ...
      if (error || !data || data.length === 0) {
        ...
        const formattedStaticData = staticTestimonials.map((t) => ({
            title: t.name,
            subtitle: t.quote,
  ...
  return (
    <>
      ...
      <div className="h-screen w-full flex bg-background overflow-hidden">
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-4 sm:p-6 md:p-8 relative overflow-hidden">
          <motion.div 
          ...
          />
          <motion.div 
            className="absolute -bottom-20 -right-20 w-48 h-48 bg-green-400/10 rounded-full blur-3xl"
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden border-l border-border/50">
