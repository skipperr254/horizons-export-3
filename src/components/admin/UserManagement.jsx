...
import { Users, Shield, Crown, Mail, Calendar, CheckCircle, XCircle, AlertTriangle, Edit3 } from 'lucide-react';
import UserFilters from './UserFilters';
import UserActions from './UserActions';
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar';
import { useMediaQuery } from '@/hooks/useMediaQuery';

const UserManagement = ({ users, onTogglePremium, onUpdateRole, onDeleteUser, updatingUser, onRefresh, isRefreshing }) => {
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        {users.length === 0 ? (
          <div className="text-center py-8"><Users className="h-12 w-12 text-muted-foreground mx-auto mb-4" /><p className="text-muted-foreground mb-2">Henüz kayıtlı kullanıcı yok.</p><Button variant="outline" onClick={onRefresh} disabled={isRefreshing}><CheckCircle className="h-4 w-4 mr-2" />Kullanıcıları Yenile</Button></div>
