...
const BlogManagement = () => {
  ...
  const fetchPosts = async () => {
    ...
    if (error) {
      toast({
        title: "Hata",
        description: "Blog yazıları getirilemedi.",
        variant: "destructive",
      });
    } else {
      setPosts(data);
  ...
  const handleImageUpload = async (event) => {
    ...
    try {
      ...
      toast({
        title: "Hata",
        description: `Resim yüklenemedi: ${error.message}`,
        variant: "destructive",
      });
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.error) {
      toast({
        title: "Hata",
        description: `Yazı kaydedilemedi: ${result.error.message}`,
        variant: "destructive",
      });
    } else {
      toast({
        title: "Başarılı",
        description: `Yazı ${editingPost ? "güncellendi" : "oluşturuldu"}.`,
      });
      resetForm();
      fetchPosts();
    }
