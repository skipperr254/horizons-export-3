  ...
  const SecureAvatarDisplay = ({ avatarUrl, name, email }) => {
    ...
    return (
      <div className='relative' onContextMenu={(e) => e.preventDefault()}>
        <Avatar className='h-32 w-32 border-4 border-primary/20 shadow-xl transition-all duration-300 group-hover:shadow-primary/20 pointer-events-none'>
          <AvatarImage
            src={avatarUrl}
            alt={name}
      ...
      <CardContent className='space-y-8 p-6'>
          ...
          <motion.div whileHover={{ scale: 1.05 }} className='relative group'>
            ...
            {canAccessPremiumFeatures && (
              <motion.div
                ...
                className='absolute -top-2 -right-2 p-1 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full shadow-lg'
              >
                <Crown
            ...
            <div className='space-y-2'>
              ...
              <div className='relative'>
                ...
                <Input
                  ...
                  disabled
                  className='h-12 text-lg bg-muted pl-12 border-2'
                />
              </div>
            </div>
          </div>
        ...
        <div className='space-y-6'>
          <div className='flex items-center space-x-3'>
            ...
            <div>
              <h3 className='text-xl font-bold'>Avatarını Seç</h3>
              <p className='text-sm text-muted-foreground'>
                {canAccessPremiumFeatures
                  ? "Premium üye olarak 15 farklı avatar arasından seçim yapabilirsin!"
                  : "5 ücretsiz avatar arasından seçim yap veya premium'a geç!"}
              </p>
            </div>
          </div>
          <AvatarSelection
