        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-first lg:order-last">
            <motion.h2
              ...
              viewport={{ once: true, amount: 0.5 }}
              transition={{ duration: 0.8, ease: 'easeOut' }}
              className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter text-slate-900 dark:text-white"
            >
              Neden
            ...
            <motion.p
              ...
              className="mt-6 max-w-xl mx-auto lg:mx-0 text-base md:text-lg text-slate-600 dark:text-slate-400"
            >
              HikayeGO ile dil öğrenimi bir görevden keyifli bir maceraya dönüşür. Sıkıcı ders kitaplarını bir kenara bırakın ve İngilizceyi yaşayarak öğrenin.
            </motion.p>
