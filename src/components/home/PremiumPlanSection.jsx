...
const premiumFeatures = [
    { text: "Anında çeviri ile anlamadığın kelime kalmasın" },
    { text: "Hikayeleri sesli dinleyerek telaffuzunu geliştir" },
    { text: "Kaldığın yeri işaretle, öğrenmeye ara verme" },
    { text: "Kişisel asistan ile dilbilgisi ve kelime önerileri al" },
    { text: "Reklamsız ve kesintisiz bir öğrenme deneyimi" },
    { text: "Yeni hikayelere ve özelliklere herkesten önce eriş" },
];

const badgeTexts = ["En Popüler", "3 Gün Ücretsiz Dene"];
                    ...
                    >
                        <Card className="relative z-10 w-full rounded-2xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl shadow-2xl shadow-primary/10 border-2 border-white/50 dark:border-slate-800/80 overflow-hidden">
                            <CardHeader className="text-center p-8 pb-4">
                                ...
                                <p className="text-sm text-muted-foreground mt-1">(3 gün deneme sonrası)</p>
                            </CardHeader>
                            ...
                            <CardContent className="p-8 pt-6">
                                ...
                                <Button onClick={handleCtaClick} size="lg" className="w-full text-lg cta-glow-button py-6">
                                    ...
                                    {user ? "Premium'a Geç" : 'Ücretsiz Denemeyi Başlat'}
                                </Button>
