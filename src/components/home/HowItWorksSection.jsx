...
const steps = [
  ...
  },
  {
    ...
    description: "3 günlük ücretsiz deneme ile tüm hikayelere, sesli okuma özelliğine ve reklamsız arayüze sınırsız erişim kazanın.",
  },
  {
    icon: TrendingUp,
  ...
  return (
    <section id="how-it-works" className="relative py-20 sm:py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="relative text-center mb-16 max-w-3xl mx-auto p-6 rounded-3xl">
          <div className="absolute inset-0 bg-white/30 dark:bg-slate-800/20 backdrop-blur-lg rounded-3xl border border-white/20 dark:border-slate-700/20 -z-10"></div>
          <motion.h2 
          ...
          >
            Öğrenme yolculuğunuz sadece 4 basit adımdan oluşuyor.
          </motion.p>
        </div>
