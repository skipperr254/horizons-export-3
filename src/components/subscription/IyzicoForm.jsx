...
const IyzicoForm = () => {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://vjxkmufoztgzrnwaxswo.supabase.co/functions/v1/iyzico-initialize-payment", {
        method: 'POST',
        headers: {
      ...
      if (result.checkoutFormContent) {
        navigate('/subscription/iyzico-checkout', { state: { checkoutFormContent: result.checkoutFormContent } });
