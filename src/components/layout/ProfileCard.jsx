        ...
        <div className="flex flex-col items-center space-y-4">
           ...
           <TooltipProvider delayDuration={0}>
              <Tooltip>
                ...
                <TooltipContent side="left" align="center"><p>Profili Görüntüle</p></TooltipContent>
              </Tooltip>
           </TooltipProvider>
           ...
           <TooltipProvider delayDuration={0}>
            <Tooltip>
              ...
              <TooltipContent side="left" align="center"><p>Haftalık Hedef: {readStoriesCount}/{weeklyGoal}</p></TooltipContent>
            </Tooltip>
           </TooltipProvider>
           <div className="w-full border-t my-2"></div>
           <TooltipProvider delayDuration={0}>
              <Tooltip>
                  ...
                  <TooltipContent side="left" align="center"><p>Ayarlar</p></TooltipContent>
              </Tooltip>
           </TooltipProvider>
        </div>
      ) : (
